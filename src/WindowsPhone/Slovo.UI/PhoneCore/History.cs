namespace Slovo.Core
{
    ...
    internal class History : IListIterator<Directions.DirectionArticle>
    {
        ...
        internal List<Slovo.Core.Directions.DirectionArticle> Items
        {
            get
            {
                if (this.all == null)
                {
                    ...
                    this.all = settings.Contains(HistoryKey) ? (List<Slovo.Core.Directions.DirectionArticle>)settings[HistoryKey] : new List<Slovo.Core.Directions.DirectionArticle>();
                }
        ...
        internal void Save()
        {
            ...
            {
                settings[HistoryKey] = this.Items;
            }
            else 
            {
                settings.Add(HistoryKey, this.Items);
            }
