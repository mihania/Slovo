namespace Slovo.UI
{
    ...
    /// </summary>
    public sealed partial class Main2 : Page
    {
        ...
        public Main2()
        {
            ...
            MainPivot.PivotItemLoading += MainPivot_LoadingPivotItem;
        ...
        private void OpenWord(int directionArticleId)
        {
            ...
            this.Frame.Navigate(typeof(DirectionArticle), new DirectionArticleNavigateParams() { DirectionId = ManagerInstance.CurrentDirection.Id, DirectionArticleId = directionArticleId });
        }
