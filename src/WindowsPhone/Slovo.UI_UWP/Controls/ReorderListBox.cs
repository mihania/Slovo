...
namespace Slovo.Controls
{
    ...
    /// </summary>
    [TemplatePart(Name = ReorderListBox.DragIndicatorPart, Type = typeof(Windows.UI.Xaml.Controls.Image))]
    [TemplatePart(Name = ReorderListBox.DragInterceptorPart, Type = typeof(Windows.UI.Xaml.Controls.Canvas))]
    [TemplatePart(Name = ReorderListBox.ScrollViewerPart, Type = typeof(Windows.UI.Xaml.Controls.ScrollViewer))]
    public class ReorderListBox
       : Windows.UI.Xaml.Controls.ListBox
    {
        ...
        private Windows.UI.Xaml.Controls.Panel itemsPanel;
        private Windows.UI.Xaml.Controls.ScrollViewer scrollViewer;
        private Windows.UI.Xaml.Controls.Canvas dragInterceptor;
        private Windows.UI.Xaml.Controls.Image dragIndicator;
        private object dragItem;
        private ReorderListBoxItem dragItemContainer;
        private Windows.Foundation.Rect dragInterceptorRect;
        ...
        public static readonly Windows.UI.Xaml.DependencyProperty IsReorderEnabledProperty = Windows.UI.Xaml.DependencyProperty.Register(ReorderListBox.IsReorderEnabledPropertyName, typeof(bool), typeof(ReorderListBox), new PropertyMetadata(false, (d, e) => ((ReorderListBox)d).OnIsReorderEnabledChanged(e)));
        ...
        protected void OnIsReorderEnabledChanged(Windows.UI.Xaml.DependencyPropertyChangedEventArgs e)
        {
            ...
            {
                this.dragInterceptor.Visibility = (bool)e.NewValue ? Windows.UI.Xaml.Visibility.Visible : Windows.UI.Xaml.Visibility.Collapsed;
            }
        ...
        public static readonly Windows.UI.Xaml.DependencyProperty AutoScrollMarginProperty = Windows.UI.Xaml.DependencyProperty.Register("AutoScrollMargin", typeof(int), typeof(ReorderListBox), new PropertyMetadata(32));
        ...
        protected override void OnApplyTemplate()
        {
            ...
            this.scrollViewer = (Windows.UI.Xaml.Controls.ScrollViewer)this.GetTemplateChild(ReorderListBox.ScrollViewerPart);
            this.dragInterceptor = this.GetTemplateChild(ReorderListBox.DragInterceptorPart) as Windows.UI.Xaml.Controls.Canvas;
            this.dragIndicator = this.GetTemplateChild(ReorderListBox.DragIndicatorPart) as Windows.UI.Xaml.Controls.Image;
            if (this.scrollViewer != null && this.dragInterceptor != null && this.dragIndicator != null)
            {
                this.dragInterceptor.Visibility = this.IsReorderEnabled ? Windows.UI.Xaml.Visibility.Visible : Windows.UI.Xaml.Visibility.Collapsed;
        ...
        protected override void PrepareContainerForItemOverride(Windows.UI.Xaml.DependencyObject element, object item)
        {
            ...
            string reorderState = this.IsReorderEnabled ? ReorderListBoxItem.ReorderEnabledState : ReorderListBoxItem.ReorderDisabledState;
            Windows.UI.Xaml.VisualStateManager.GoToState(itemContainer, reorderState, false);
            itemContainer.SetBinding(ReorderListBoxItem.IsReorderEnabledProperty, new Windows.UI.Xaml.Data.Binding()
            {
                Path = new PropertyPath(ReorderListBox.IsReorderEnabledPropertyName)
            });
            if (item == this.dragItem)
            {
                Windows.UI.Xaml.VisualStateManager.GoToState(itemContainer, ReorderListBoxItem.DraggingState, false);
                if (this.dropTargetIndex >= 0)
                {
                    // The item's dragIndicator is currently being moved, so the item itself is hidden. 
                    itemContainer.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                ...
                else
                {
                    ...
                    Windows.UI.Xaml.VisualStateManager.GoToState(itemContainer, ReorderListBoxItem.NotDraggingState, true);
                    this.dragItem = null;
                }
            }
            else
            {
                Windows.UI.Xaml.VisualStateManager.GoToState(itemContainer, ReorderListBoxItem.NotDraggingState, false);
            }
        }
        ...
        /// </summary>
        protected override void ClearContainerForItemOverride(Windows.UI.Xaml.DependencyObject element, object item)
        {
            base.ClearContainerForItemOverride(element, item);
            ReorderListBoxItem itemContainer = (ReorderListBoxItem)element;
            if (itemContainer == this.dragItemContainer)
            {
                this.dragItemContainer.Visibility = Windows.UI.Xaml.Visibility.Visible;
        ...
        private void dragInterceptor_ManipulationStarted(object sender, Windows.UI.Xaml.Input.ManipulationStartedRoutedEventArgs e)
        {
            if (this.itemsPanel == null)
            {
                ...
                this.itemsPanel = (Windows.UI.Xaml.Controls.Panel)Windows.UI.Xaml.Media.VisualTreeHelper.GetChild(scrollItemsPresenter, 0);
            }
            Windows.UI.Xaml.Media.GeneralTransform interceptorTransform = this.dragInterceptor.TransformToVisual(Windows.UI.Xaml.Window.Current.Content);
            Windows.Foundation.Point targetPoint = interceptorTransform.TransformPoint(e.Position);
            targetPoint = ReorderListBox.GetHostCoordinates(targetPoint);
            List<Windows.UI.Xaml.UIElement> targetElements = Windows.UI.Xaml.Media.VisualTreeHelper.FindElementsInHostCoordinates(targetPoint, this.itemsPanel).ToList();
            ...
            {
                Windows.UI.Xaml.VisualStateManager.GoToState(targetItemContainer, ReorderListBoxItem.DraggingState, true);
                Windows.UI.Xaml.Media.GeneralTransform targetItemTransform = targetItemContainer.TransformToVisual(this.dragInterceptor);
                Windows.Foundation.Point targetItemOrigin = targetItemTransform.TransformPoint(new Windows.Foundation.Point(0, 0));
                Windows.UI.Xaml.Controls.Canvas.SetLeft(this.dragIndicator, targetItemOrigin.X);
                Windows.UI.Xaml.Controls.Canvas.SetTop(this.dragIndicator, targetItemOrigin.Y);
                ...
                this.dragInterceptorRect = interceptorTransform.TransformBounds(new Windows.Foundation.Rect(new Windows.Foundation.Point(0, 0), this.dragInterceptor.RenderSize));
        ...
        private async void dragInterceptor_ManipulationDelta(object sender, Windows.UI.Xaml.Input.ManipulationDeltaRoutedEventArgs e)
        {
            ...
            if (this.dropTargetIndex == -1)
            {
                ...
                Windows.Foundation.Size dragItemSize = this.dragItemContainer.RenderSize;
                Windows.UI.Xaml.Media.Imaging.WriteableBitmap writeableBitmap = new WriteableBitmap((int)dragItemSize.Width, (int)dragItemSize.Height);
                // Swap states to force the transition to complete.
                Windows.UI.Xaml.VisualStateManager.GoToState(this.dragItemContainer, ReorderListBoxItem.NotDraggingState, false);
                Windows.UI.Xaml.VisualStateManager.GoToState(this.dragItemContainer, ReorderListBoxItem.DraggingState, false);
                await WindowsPhoneUWP.UpgradeHelpers.WriteableBitmapHelper.RenderHelper(writeableBitmap, this.dragItemContainer, null);
                writeableBitmap.Invalidate();
                this.dragIndicator.Source = writeableBitmap;
                this.dragIndicator.Visibility = Windows.UI.Xaml.Visibility.Visible;
                this.dragItemContainer.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
                if (this.itemsPanel.Children.IndexOf(this.dragItemContainer) < this.itemsPanel.Children.Count - 1)
                {
                    this.UpdateDropTarget(Windows.UI.Xaml.Controls.Canvas.GetTop(this.dragIndicator) + this.dragIndicator.Height + 1, false);
                }
                else
                {
                    this.UpdateDropTarget(Windows.UI.Xaml.Controls.Canvas.GetTop(this.dragIndicator) - 1, false);
                }
            }
            double dragItemHeight = this.dragIndicator.Height;
            Windows.UI.Xaml.Media.TranslateTransform translation = (Windows.UI.Xaml.Media.TranslateTransform)this.dragIndicator.RenderTransform;
            double top = Windows.UI.Xaml.Controls.Canvas.GetTop(this.dragIndicator);
            translation.Y = Math.Max(-top - 0.01, Math.Min(e.Cumulative.Translation.Y, this.dragInterceptorRect.Height - top - dragItemHeight + 0.01));
        ...
        private void dragInterceptor_ManipulationCompleted(object sender, Windows.UI.Xaml.Input.ManipulationCompletedRoutedEventArgs e)
        {
            ...
            this.dragIndicator.Visibility = Windows.UI.Xaml.Visibility.Collapsed;
            ((Windows.UI.Xaml.Media.TranslateTransform)this.dragIndicator.RenderTransform).Y = 0;
            ...
            {
                this.dragItemContainer.Visibility = Windows.UI.Xaml.Visibility.Visible;
                Windows.UI.Xaml.VisualStateManager.GoToState(this.dragItemContainer, ReorderListBoxItem.NotDraggingState, true);
                this.dragItemContainer = null;
                this.dragItem = null;
            }
            this.dragScrollDelta = 0;
        ...
        private void DragScroll()
        {
            if (this.dragScrollDelta != 0)
            {
                ...
                this.scrollViewer.ChangeView(null, newOffset, null, true);
        ...
        {
            Windows.Foundation.Point dragPoint = ReorderListBox.GetHostCoordinates(new Windows.Foundation.Point(this.dragInterceptorRect.Left, this.dragInterceptorRect.Top + dragItemOffset));
            IEnumerable<Windows.UI.Xaml.UIElement> targetElements = Windows.UI.Xaml.Media.VisualTreeHelper.FindElementsInHostCoordinates(dragPoint, this.itemsPanel);
            ReorderListBoxItem targetItem = targetElements.OfType<ReorderListBoxItem>().FirstOrDefault();
            if (targetItem != null)
            {
                Windows.UI.Xaml.Media.GeneralTransform targetTransform = targetItem.DragHandle.TransformToVisual(this.dragInterceptor);
                Windows.Foundation.Rect targetRect = targetTransform.TransformBounds(new Windows.Foundation.Rect(new Windows.Foundation.Point(0, 0), targetItem.DragHandle.RenderSize));
                ...
                if (indicatorItem == null)
                {
                    ...
                    string dropIndicatorState = after ? ReorderListBoxItem.DropAfterIndicatorState : ReorderListBoxItem.DropBeforeIndicatorState;
                    Windows.UI.Xaml.VisualStateManager.GoToState(targetItem, dropIndicatorState, showTransition);
                ...
                for (int i = targetIndex - 5; i <= targetIndex + 5; i++)
                {
                    if (i >= 0 && i < childrenCount)
                    {
                        ...
                        {
                            Windows.UI.Xaml.VisualStateManager.GoToState(nearbyItem, ReorderListBoxItem.NoDropIndicatorState, showTransition);
        ...
        private void ClearDropTarget()
        {
            ...
            {
                Windows.UI.Xaml.VisualStateManager.GoToState(itemContainer, ReorderListBoxItem.NoDropIndicatorState, false);
        ...
        private bool MoveItem(object item, int toIndex)
        {
            ...
            if (!(sourceList is System.Collections.Specialized.INotifyCollectionChanged))
            {
                ...
                // ToDo: uncomment and resolve compilation error.
        ...
        /// </summary>
        private static Windows.Foundation.Point GetHostCoordinates(Windows.Foundation.Point point)
        {
            Frame frame = (Frame)Windows.UI.Xaml.Window.Current.Content;
            switch (Windows.Graphics.Display.DisplayInformation.GetForCurrentView().CurrentOrientation)
            {
                case Windows.Graphics.Display.DisplayOrientations.Landscape:
                    return new Windows.Foundation.Point(frame.RenderSize.Width - point.Y, point.X);
                case Windows.Graphics.Display.DisplayOrientations.LandscapeFlipped:
                    return new Windows.Foundation.Point(point.Y, frame.RenderSize.Height - point.X);
                default:
                    return point;
            }
        }
