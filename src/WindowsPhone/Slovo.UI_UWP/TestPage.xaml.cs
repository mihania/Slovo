...
namespace Slovo
{
    ...
    public sealed partial class TestPage : Page
    {
        ...
        {
            var keyValuePair = ManagerInstance.CurrentDirection.GetArticle(ManagerInstance.CurrentDirection.Cursor).DefinitionOffsets;
            var vocabulary = ManagerInstance.GetVocabulary(0);
            var coreArticle = vocabulary.GetArticle(keyValuePair[0]);
            tbDefinition2.Definition = coreArticle.Definition;
        }
    }
}
